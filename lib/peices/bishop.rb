...
class Bishop
  ...
  def left_upwards_positions(board, x, y) # rubocop:disable Metrics/AbcSize,Naming/MethodParameterName
    positions = []
  ...
  def right_upwards_positions(board, x, y) # rubocop:disable Metrics/AbcSize,Naming/MethodParameterName
    positions = []
  ...
  def left_downwards_positions(board, x, y) # rubocop:disable Metrics/AbcSize,Naming/MethodParameterName
    positions = []
  ...
  def right_downwards_positions(board, x, y) # rubocop:disable Metrics/AbcSize,Naming/MethodParameterName
    positions = []
