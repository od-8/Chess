...
module AddPieces
  ...
  def add_rooks
    board[7][0] = Rook.new("rook", "\u265c", "white")
    board[7][7] = Rook.new("rook", "\u265c", "white")
    board[0][0] = Rook.new("rook", "\u2656", "black")
    board[0][7] = Rook.new("rook", "\u2656", "black")
  end
  ...
  def add_pawns
    8.times do |index = 0|
      board[6][index] = WhitePawn.new("pawn", "\u265f", "white")
      board[1][index] = BlackPawn.new("pawn", "\u2659", "black")
    end
  end
end
