...
class Board
  ...
  def check_and_checkmate
    if in_check?(board, white_king_cords, "white")
      puts "Check"
      # puts "Checkmate" if checkmate?(board, white_king_cords, "white")
    end

    if in_check?(board, black_king_cords, "black") # rubocop:disable Style/GuardClause
      puts "Check"
      # puts "Checkmate" if checkmate?(board, black_king_cords, "black")
    end
  end
  ...
  def checkmate?(_board, _king_cords, _color)
    false
  end
